...
var createNewTaskElement = function (taskString) {
  ...
  listItem.className = "todo-block__tasks-list";
  //input (checkbox)
...
var editTask = function () {
  ...
  var containsClass = listItem.classList.contains("todo-block__tasks-list_edit");
  ...
  listItem.classList.toggle("todo-block__tasks-list_edit");
};
...
var taskCompleted = function () {
  ...
  var listItem = this.parentNode;
  listItem.classList.add("todo-block__tasks-list_completed");
...
//select ListItems children
  ...
  var editButton = taskListItem.querySelector(".todo-block__button_edit");
  var deleteButton = taskListItem.querySelector(".todo-block__button_delete");
